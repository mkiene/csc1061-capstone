...
#
#   The './src/main.cpp' file is the entrypoint for the program. This is used to
...
# ------------------------------------IMPORTANT------------------------------------
#
# To compile and run this project, you should use CMake. This project was built and
# tested using MacOS using CMake. You can download CMake at https://cmake.org.
#
#   To compile using CMake, follow these steps:
#
#   1. In a terminal window, navigate to the directory './build/', where '.' is the
#       root directory for the project. This 'build' directory should be empty.
#
